class Queries {
  static List questionAnswers = [
    {
      "question": "What is the new corona virus?",
      "answer":
    ...
    {
      "question":"Is the new corona virus like SARS?",
      "answer":"SARS is a corona virus that was identified in 2003 and belongs to the same large family of viruses as the new coronavirus. Therefore, SARS and the new corona virus are distantly related. Both viruses are capable of causing severe disease. However, the new corona virus does not appear to transmit easily between people while the SARS virus was much more transmissible."
    },
    {
    ...
    {
      "question":"Is there a vaccine for the new coronavirus?",
